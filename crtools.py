...
def run_cppi(risky_r, safe_r=None, m=3, start=1000, floor=0.8, riskfree_rate=0.03, drawdown=None):
    ...
    backtest_result = {
        ...
        "drawdown": drawdown,
        "peak": peak_history,
        "floor2": floorval_history
    }
    return backtest_result


def summary_stats(r, periods_per_year = 12, riskfree_rate=0.03):
    """
...
def cov_to_corr(r, cov):
    sd = r.std()
    return pd.DataFrame(cov / np.outer(sd, sd), index=cov.index, columns=cov.columns)
